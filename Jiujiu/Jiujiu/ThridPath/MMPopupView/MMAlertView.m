...
- (instancetype)init
{
    ...
    if ( self )
    {
        ...
        self.detailColor        = MMHexColor(0x454545FF);
        self.splitColor         = MMHexColor(0xffffffFF);

        self.itemNormalColor    = MMHexColor(0x454545FF);
        self.itemHighlightColor = MMHexColor(0xFFA200FF);
        self.itemPressedColor   = MMHexColor(0x454545FF);
